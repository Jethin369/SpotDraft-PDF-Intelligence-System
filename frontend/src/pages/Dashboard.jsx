...
export default function Dashboard() {
  ...
  const fetchDocs = async () => {
    const res = await fetch(`https://spotdraft-pdf-v3.onrender.com/documents?user_id=${userId}`);
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await fetch('https://spotdraft-pdf-v3.onrender.com/upload', { method: 'POST', body: formData });
      if (!res.ok) {
